...
const getDataFromDOM = async () =>{
  ...
  data.forEach(details => {
    ...
    divi5.setAttribute("class","col-sm-6 col-md-4 col-lg-4 col-xl-4 m-1 mx-auto");
...
divi8.innerHTML = `<img class="card-img-top p-2" src= ${details.flags.png} height = '90' width='200'>`;
...
divi10.setAttribute("class","popup");
